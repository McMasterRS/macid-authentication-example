...
export default function Page_1() {
  ...
  const handleRetrieve = () => {
    ...
    let message =
      secure_var || insecure_var
        ? `Secure Variable: ${secure_var} - Insecure Variable: ${insecure_var}`
          ...
          <PermissionGate>
            <>
              ...
              >
                <TextField
                  ...
                  onChange={(
                    ...
                    setSecureVar(event.target.value as string);
                  }}
                />
                <TextField
                  id="insecure_var"
                  label="Insecure Variable"
                  variant="outlined"
                  onChange={(
                    event: React.ChangeEvent<
                      HTMLInputElement | HTMLTextAreaElement
                    ...
                    setInsecureVar(event.target.value as string);
                  }}
                />
              </Stack>
              <Stack
              ...
              >
                ...
                <Button variant="contained" onClick={handleRetrieve}>
                  {" "}
                  Retrieve Data{" "}
                </Button>
                <Button variant="contained" onClick={handleDelete}>
                  {" "}
                  Delete Secure Varibale{" "}
                </Button>
